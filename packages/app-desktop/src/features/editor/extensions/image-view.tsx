...
export const DarkwriteImageView = (props: DarkwriteImageViewProps) => {
  ...
  return <NodeViewWrapper className="dwimage">
    <div data-drag-handle="" className="flex justify-center dwimage-container">
      {embedId == null ? <span className="opacity-50">Loading image...</span> : <img data-drag-handle="" src={imageSource}/>}
    </div>
  </NodeViewWrapper>  
}