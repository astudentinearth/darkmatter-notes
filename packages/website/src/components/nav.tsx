...
export async function Nav() {
  return (
    <nav className="bg-nav absolute left-1/2 -translate-x-1/2 p-3 border border-[#c1c1c1]/25 rounded-[18px] flex gap-3 top-3">
      <Link href={"/"}>
      ...
      <div className="h-10 flex justify-center items-center p-3 select-none hover:bg-white/10 transition-colors rounded-[6px]">
        Resources
        <div className="absolute bg-nav border-[#c1c1c1]/25 p-3 border rounded-[18px] top-[4.5rem]">
          User guide
        </div>
      </div>
      <Link
