    ...
    >
      {mouseOver && embedId && (
        <>
          <Button
            variant={"ghost"}
            className="rounded-xl bg-secondary/50 hover:!bg-secondary/80 z-20 font-ui text-foreground"
            onClick={changeCover}
          >
            Change cover
          </Button>
          <Button
            onClick={removeCover}
            variant={"ghost"}
            className="rounded-xl bg-secondary/50 hover:!bg-secondary/80 z-20 gap-2 font-ui text-foreground"
          >
            <ImageOff size={18} />
            Remove
          </Button>
