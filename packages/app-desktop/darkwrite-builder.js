...
if(artifactExists){
    console.log("Found older artifacts for this version. Removing for rebuild...")
...
const process = proc.spawn(`yarn`, [scripts[os.type()]], {stdio: "inherit", shell: true});
...
process.on("exit", ()=>{
    ...
    console.log(`\u001b[32;1m ✔ Built Darkwrite ${version} for ${os.type()} \u001b[30;22mtook ${(endTimestamp-startTimestamp)/1000}s\u001b[0m`);
})
